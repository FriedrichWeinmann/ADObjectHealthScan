...
Remove-Module ADObjectHealthScan -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ADObjectHealthScan.psd1"
Import-Module "$PSScriptRoot\..\ADObjectHealthScan.psm1" -Force
