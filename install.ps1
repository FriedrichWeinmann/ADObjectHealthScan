<#
	.SYNOPSIS
		Installs the ADObjectHealthScan Module from github
		
	.DESCRIPTION
		This script installs the ADObjectHealthScan Module from github.
